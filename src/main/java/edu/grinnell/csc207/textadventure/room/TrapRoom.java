...
public class TrapRoom extends Room {
    ...
    public TrapRoom() {
        super("Trap Room", "A suspicious room with a trap door. Be careful!");
    }

    @Override
    public boolean onWait() {
        System.out.println("You fell into a trap and now you're outside!");
        System.out.println("You just got an allergic reaction to grass!");
        System.out.println("\n=== GAME OVER ===");
        return true;
    }
